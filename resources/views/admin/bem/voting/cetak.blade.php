    ...
    <center>
        <div class="container">
                ...
                <div class="row align-items-start">
                    ...
                    <div class="col-8 text-center">
                        ...
                        <h3>
                            ...
                            <br> Presiden dan Wakil Presiden
                            <br> {{ $org->nama }}
            ...
            <div class="container">
                ...
                <br>
                <h3>SELAMAT KEPADA PRESIDEN DAN WAKIL PRESIDEN TERPILIH</h3>
                <br>
                @foreach ($data as $dt)
                ...
                <div class="row justify-content-center">
                    <div class="col-sm-4 mb-3 ">
                        ...
                        <div class="card">
                            <h5 class="card-header">Presiden Terpilih</h5>
                    ...
                    <div class="col-sm-4 mb-3 ">
                        ...
                        <div class="card">
                            <h5 class="card-header">Wakil Presiden Terpilih</h5>
