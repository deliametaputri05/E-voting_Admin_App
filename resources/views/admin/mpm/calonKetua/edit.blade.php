        ...
        <div class="page-inner">
            <div class="page-header">
                ...
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="/dashboard/mpmCalonKetua">Calon Ketua</a>
                    </li>
                    <li class="separator">
                        <i class="flaticon-right-arrow"></i>
                    </li>
            ...
            <div class="py-12">
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div>
                        ...
                        @endif
                        <form class="w-full" action="{{ route('mpmCalonKetua.update', $id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-lg-8">
                                                    ...
                                                    <div class="card-action">
                                                        ...
                                                        <a href="/dashboard/mpmCalonKetua" class="btn btn-danger" on>Cancel</a>
