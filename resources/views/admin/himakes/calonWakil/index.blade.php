    ...
    <div class="content">
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">Himpunan Mahasiswa Kesehatan</h4>
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="/dashboard/himakesCalonWakil">Calon Wakil</a>
                    </li>
                    <li class="separator">
                        <i class="flaticon-right-arrow"></i>
                    </li>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                ...
                                <a href="/dashboard/himakes/calonWakil/create" class="btn btn-primary btn-round ml-auto">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    <a href="{{ route('himakesCalonWakil.edit', $item->id) }}" type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit Data">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    <form action="{{ route('himakesCalonWakil.destroy', $item->id) }}" method="POST" class="inline-block">
