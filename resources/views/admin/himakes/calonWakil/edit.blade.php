    ...
    <div class="content">
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">Edit Calon Wakil</h4>
            ...
            <div class="py-12">
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div>
                        ...
                        @endif
                        <form class="w-full" action="{{ route('himakesCalonWakil.update', $id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-lg-8">
                                                    ...
                                                    <div class="card-action">
                                                        ...
                                                        <a href="/dashboard/himakesCalonWakil" class="btn btn-danger" on>Cancel</a>
