...
@section('title', 'Create Calon Wakil')
            ...
            <div class="py-12">
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div>
                        ...
                        @endif
                        <form class="w-full" action="{{ route('himatifCalonWakil.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-lg-8">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="nama" name="nama" value="{{ old('nama') }}" placeholder="Nama Calon Wakil">
                                                    </div>
                                                    <div class="form-group">
