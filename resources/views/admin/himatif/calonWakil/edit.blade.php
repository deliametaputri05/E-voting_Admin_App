...
@section('title', 'Edit Calon Wakil')
    ...
    <div class="content">
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">HIMATIF</h4>
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="/dashboard/himatifCalonWakil">Calon Wakil</a>
                    </li>
                    <li class="separator">
                        <i class="flaticon-right-arrow"></i>
                    </li>
            ...
            <div class="py-12">
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div>
                        ...
                        @endif
                        <form class="w-full" action="{{ route('himatifCalonWakil.update', $id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-lg-8">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="nama" name="nama" value="{{ old('nama') ?? $item->nama  }}" placeholder="Nama Calon Wakil">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="card-action">
                                                        ...
                                                        <a href="/dashboard/himatifCalonWakil" class="btn btn-danger" on>Cancel</a>
