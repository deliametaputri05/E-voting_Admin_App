    ...
    <div class="content">
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">Calon Wakil HIMATIF</h4>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                ...
                                <a href="/dashboard/himatif/calonWakil/create" class="btn btn-primary btn-round ml-auto">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    <a href="{{ route('himatifCalonWakil.edit', $item->id) }}" type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit pemira">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    <form action="{{ route('himatifCalonWakil.destroy', $item->id) }}" method="POST" class="inline-block">
