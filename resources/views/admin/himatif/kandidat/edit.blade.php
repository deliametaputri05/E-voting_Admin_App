            ...
            <div class="py-12">
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div>
                        ...
                        @endif
                        <form class="w-full" action="{{ route('himatifKandidat.update', $id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                                                ...
                                                <div class="col-md-6 col-lg-8">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="id_clnWakil" name="id_clnWakil">
                                                            ...
                                                            <option value={{ $item->id_clnWakil }}>{{ $item->calonWakil->nama }} ({{$item->calonWakil->nim}})</option>
                                                    ...
                                                    <div class="card-action">
                                                        ...
                                                        <a href="/dashboard/himatifKandidat" class="btn btn-danger" on>Cancel</a>
